  ...
  <section class="login-box">
    <div class="login-logo">
      <div class="text-green">
       <!-- <p><strong><?php echo store('name'); ?></strong></p>-->
         <p><strong><?php echo "EDS USUARIO:coomulpinort CLAVE:1234567 "; ?></strong></p>
         <img src="assets/itsolution24/img/logo-favicons/POST_EDS_API_DOC_ELEC.jpeg" alt="API DOCUMENTOS ELECTRONICOS" width="300" height="250">
      </div>
    </div>
    <?php
      ...
      <form id="login-form" action="login.php" method="post">       
        ...
        <div class="form-group">
          <div class="input-group">
            ...
            <input type="text" class="form-control" placeholder="Usuario" name="username" value="">
          </div>
        </div>
        ...
        <center>
           <!--  <?php echo 'Usuario:poliedro'; ?></br>
           <?php echo 'Clave:7654321'; ?>-->
        </center>
        <button type="submit" id="login-btn" class="btn btn-primary btn-block btn-flat" data-loading-text="Logging...">
    ...
    <div class="copyright text-center">
      <p>&copy; <a href="http://poliedrosoftware.com">POLIEDRO SOFTWARE S.A.S</a>, v<?php echo settings('version'); ?></p>
    </div>
  </section>
