    ...
    <tbody>
      <tr class="no-print">
        <td>
          <button  class="btn btn-danger btn-block" id="imprimir">
            <span class="fa fa-fw fa-print fa-3x"></span> 
            <?php echo trans('PDF'); ?>
          </button>
        </td>
        <!--<td>
      ...
      <tr class="text-center">
        <td colspan="2">
          <br>
          <p class="powered-by">
            <small>&copy; Poliedro Software S.A.S </small><br>
            <small> Tel: 3154286798 </small>
          </p>
        </td>
      </tr>
    </tbody>
...
<script>
    $('#imprimir').click(function(){
        htmlFactura = btoa($('section.receipt-template').html()
                ...
                .replace("Í","I").replace("Ó","O")
                .replace("Ú","U").replace("Ú","U")
                .replace("<img","<img width='10' height='10' style='width:10px'")
                .replace("1_logo.png","1_logo.png")
                .replace('"logo-area"','"logo-area" style="text-align:center"')
                .replace('class="address-area"','class="address-area" style="font-size:10px;text-align:center;"')
                .replace('<table>','<table style="font-size:10px">')
                .replace('<table>','<table style="font-size:10px">')
                .replace('<table>','<table style="font-size:10px">')
                .replace('class="main-title"','class="main-title" style="font-size:10px;font-weight:700" style="text-align:center;font-weight:700"')
                .replace('class="store-name"','class="store-name" style="font-size:10px;font-weight:700;text-align:center;"')
                .replace('class="receipt-header"','class="receipt-header" style="font-size:10px;font-weight:700;text-align: center;"')
