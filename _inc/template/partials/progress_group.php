<div class="progress-group-container">
  <div class="progress-group">
    ...
    <div class="progress sm">
      <div class="progress-bar progress-bar-success" style="width: <?php echo get_progress_percentage($invoice_amount, $discount_amount+$due_amount);?>%"></div>
    </div>
  </div>
  <div class="progress-group">
    ...
    <div class="progress sm">
      <div class="progress-bar progress-bar-success" style="width:<?php echo ($discount_amount/$invoice_amount)*100;?>%"></div>
    </div>
  </div>
  <div class="progress-group">
    ...
    <div class="progress sm">
      <div class="progress-bar progress-bar-success" style="width: <?php echo ($due_amount/$invoice_amount)*100;?>%"></div>
    </div>
  </div>
  <div class="progress-group">
  ...
  <a href="<?php root_url();?>/admin/report_overview.php" class="btn btn-sm btn-block btn-success btn-flat"><?php echo trans('button_overview_report'); ?> &rarr;</a>
</div>