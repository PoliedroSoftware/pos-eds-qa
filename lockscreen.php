...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title><?php echo ('Bloquedo');?><?php echo ' | '.store('name') ? store('name') : ''; ?></title>
...
<body class="lockscreen">
  ...
  <div class="lockscreen-wrapper">
    <h4 class="text-center text-green">POLIEDRO SOFTWARE S.A.S <small class="text-muted">v<?php echo settings('version');?></small></h4>
    <br>
    ...
    <div class="help-block text-center">
      Porfavor ingrese su contraseña para ingresar al sistema
    </div>
    <div class="text-center">
      <a href="index.php" style="font-size:1.8rem;color:green;text-decoration:underline;"><small>O</small>inicie sesion para otro usuario</a>
    </div>
    <div class="lockscreen-footer text-center">
      <div class="copyright" style="font-size:1.2rem;">Copyright © <?php echo date('Y'); ?> <a href="http://poliedrosoftware.com">poliedrosoftware.com</a></div>
    </div>
  </div>

<noscript>POLIEDRO SOFTWARE S.A.S <strong><?php echo store('name');?></strong>.</noscript>
</body>
</html>