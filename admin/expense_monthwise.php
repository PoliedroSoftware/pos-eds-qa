          ...
          <div class="box-body pt-0">
            <div class="table-responsive">                     
              <table id="expense-expense-list" class="table table-bordered table-striped table-hovered">
                <thead>
                  <tr class="bg-primary">
                      <th class="w-5 text-center bg-primary">Sl.</th>
                    <?php foreach (get_expense_categorys() as $category) : ?>
                      <th class="w-5 text-center">
                        <?php echo $category['category_name'];?>
                      </th>
                    <?php endforeach; ?>
                      <th class="w-10 text-center bg-primary">Total</th>
                  </tr>
                </thead>
                <tbody>
                  <?php
                    ...
                    for ($i=0; $i < $days_in_month; $i++) : 
                      ...
                      ?>
                      <tr class="<?php echo $is_highlisht_row ? 'bg-primary' : 'bg-gray';?>">
                          <td class="w-5 text-center bg-white"><?php echo $inc;?></td>
                        <?php foreach (get_expense_categorys() as $category) : ?>
                        ...
                        <?php endforeach;?>
                        <td class="w-10 text-center bg-primary">
