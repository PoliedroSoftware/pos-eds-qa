    ...
    <footer class="main-footer">
    	...
    	<div class="copyright">Copyright © <?php echo date('Y'); ?> <a href="http://poliedrosoftware.com">POLIEDRO SOFTWARE S.A.S    NIT: 901351995-7</a>, Todos los derechos reservado.</div>
    </footer>
</div>
<!-- End Wrapper -->
