  ...
  <section class="content">
    ...
    <div class="box box-info">
      ...
      <div class="box-footer">
        <p class="text-blue"><i>* El envío de SMS es una tarea que requiere mucho tiempo. Puede llevar de unos segundos a unos minutos realizar varios minutos. Por lo tanto, es muy recomendable configurar Cronjob en Linux o programar una tarea en Windows para suavizar esta tarea.</i></p>
      </div>
    </div>
