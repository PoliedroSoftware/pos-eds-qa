	...
	<section class="content">
	    ...
	    <div class="box">
	      <div class="box-body">
	        ...
	        <div class="alert alert-warning mb-0">
	          <p><span class="fa fa-fw fa-info-circle"></span>POLIEDRO </p>
	        </div>
	      </div>
	    </div>
	    <?php endif; ?>
		...
		<article class="app-layout">
			<div class="app-container">
				<div class="app-row">
					<header class="app-header bg-gray"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
					...
					<main class="app-col app-content">
						...
						<div class="tags">
							<h4><b><?php echo trans('text_template_tags');?></b>. Use:<code>{{ logo }}</code></h4>
							<?php 
							$template_tags = get_postemplate_empty_data();
							foreach ($template_tags as $key => $val):?> 
								<?php if (is_array($val)):?>
									<h4><b class="text-red"><?php echo ucfirst(str_replace('_', ' ', $key));?></b>  Use:<code>{{ <?php echo $key;?> }} {{ sl }} {{ /<?php echo $key;?> }}</code></h4>
