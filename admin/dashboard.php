...
<div class="content-wrapper" ng-controller="DashboardController">
  ...
  <section class="content">
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-xs-6">
        <div id="customer-count" class="small-box bg-green">
          <div class="inner">
            <h4>
      ...
      <div class="col-md-3 col-xs-6">
        <div id="supplier-count" class="small-box bg-green">
          <div class="inner">
            <h4>
      ...
      <div class="col-md-3 col-xs-6">
        <div id="product-count" class="small-box bg-green">
          <div class="inner">
            <h4>
            ...
            <div class="row">
              <div class="col-sm-6 col-xs-6">
                <div class="description-block border-right">
                  ...
                  <h4 class="description-text"><?php echo 'Ingresos de hoy'; ?></h4>
                </div>
              </div>
              <div class="col-sm-6 col-xs-6">
                <div class="description-block border-right">
                  <h2 class="description-header"><?php echo currency_format(get_bank_withdraw_amount(date('Y-m-d'), date('Y-m-d')));?></h2>
                  <h4 class="description-text"><?php echo 'Egresos de hoy'; ?></h4>
                </div>
              </div>
            </div>
          </div>
                          ...
                          <?php if ($transactions = $banking_model->getTransactions('deposit', store_id(), 3)) : ?>
                            <?php foreach ($transactions as $row) : ?>
                              <tr>
                                ...
                                <td class="w-45"><a class="view-deposit" data-refno="<?php echo $row['ref_no'];?>" href="#" tyle="white-space:nowrap;max-width:100%;overflow:hidden;display:inline-block;"><?php echo 'Entradas por ventas';?></a></td>
                        ...
                        <tbody>
                          <?php if ($transactions = $banking_model->getTransactions('withdraw', store_id(), 3)) : ?>
                            <?php foreach ($transactions as $row) : ?>
                              <tr>
                                <td class="w-35 text-center"><?php echo $row['created_at'];?></td>
                                <td class="w-45"><a class="view-withdraw" data-refno="<?php echo $row['ref_no'];?>" href="#" style="white-space:nowrap;max-width:100%;overflow:hidden;display:inline-block;"><?php echo 'Egresos';?></a></td>
                                <td class="w-20 text-right"><?php echo currency_format($row['amount']);?></td>
                              </tr>
                            <?php endforeach; ?>
                          <?php endif; ?>
