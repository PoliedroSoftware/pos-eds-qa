	    ...
	    <div class="box">
	      <div class="box-body">
	        ...
	        <div class="alert alert-warning mb-0">
	          <p><span class="fa fa-fw fa-info-circle"></span> Poliedro software</p>
	        </div>
	      </div>
	    </div>
	    <?php endif; ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<div class="well well-sm mb-0">
									...
									<div>
										<span for="preference[expiring_soon_alert_days]">Alertar antes</span>
										<input class="text-center" type="text" name="preference[expiring_soon_alert_days]" value="<?php echo get_preference('expiring_soon_alert_days');?>" onclick="this.select();" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" onKeyUp="if(this.value<0){this.value='1';}"> dias de vencerce
									</div>
								</div>
							</div>
						</div>
					...
					<div class="tab-pane<?php echo $tab_active == 'pos-setting' ? ' active' : null;?>" id="pos-setting">
						<div class="form-group">
							...
							<div class="col-sm-7">
								...
								<option value="year_sequence" <?php echo get_preference('reference_format') == 'year_sequence' ? 'selected' : null; ?>>Año/Consecutivo de numeracion segun la Dian (SL/2014/001)</option>
								<option value="year_month_sequence" <?php echo get_preference('reference_format') == 'year_month_sequence' ? 'selected' : null; ?>>Año/Mes/Consecutivo de numeracion segun la Dian (SL/2020/01/01)</option>
								<option value="sequence" <?php echo get_preference('reference_format') == 'sequence' ? 'selected' : null; ?>>Consecutivo de numeracion segun la Dian</option>
								<option value="random" <?php echo get_preference('reference_format') == 'random' ? 'selected' : null; ?>>Numeros aleotorios</option>
								</select>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								...
								<div class="well well-sm mb-0">
									<i>Para la instalación de una sola máquina local: el servidor PHP será la mejor opción y para la configuración del servidor en vivo o del servidor local (LAN): puede instalar el servidor de impresión PHP Pos localmente en cada máquina (recomendado) o usar la función de impresión del navegador web.</i>
								</div>
								<div class="well well-sm mb-0">
									<div class="form-group">
										<div class="col-sm-6">
...
<h4><b>Sincronizacion sin internet </b></h4>
RUN FROM BROWSER
...
<div class="alert alert-warning mb-0"><b>***Importante:</b> La ruta cambiará de acuerdo con su sistema operativo &amp; configuración del servidor.</div>
		</div>
	</section>
	<!-- Content End-->
