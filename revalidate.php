                    ...
                    <form id="purchaseCodeRevalidationForm" class="form-horizontal" role="form" action="<?php echo root_url();?>/revalidate.php" method="post">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6 col-sm-offset-3 text-left">
                                <button class="btn btn-success btn-block ajaxcall" data-form="purchaseCodeRevalidationForm" data-loading-text="Checking...">Enviar &rarr;</button>
                            </div>
                        </div>
                    </form>
                </div>
            </div>
            <div class="text-center copyright">&copy; <a href="http://www.poliedrosoftware.com">poliedrosoftware.com</a>, All right reserved.</div>
        </div>
    </div>
</div>
</body>
