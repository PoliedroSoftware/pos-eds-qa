...
function (
        ...
        "buttons": [
            {
                ...
                customize: function ( win ) {
                    $(win.document.body)
                        .css( 'font-size', '10pt' )
                        .append(
                            '<div><b><i>POLIEDRO SOFTWARE S.A.S</i></b></div>'
                        )
                        .prepend(
                            '<div class="dt-print-heading"><img class="logo" src="'+window.logo+'"/><h2 class="title">'+window.store.name+'</h2><p>Impreso: '+window.formatDate(new Date())+'</p></div>'
                        );
            ...
            },
            {
                ...
                titleAttr: "Excel",
                title: window.store.name + " > Listado de cliente",
                exportOptions: {
                    columns: [ 0, 2, 3, 4]
                }
            },
    ...
    $("#email-btn").on( "click", function (e) {
        ...
        var thehtml = dt.html();
        EmailModal({template: "default", subject: "Listado de cliente", title:"Listado de cliente", html: thehtml});
    });
