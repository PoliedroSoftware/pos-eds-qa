    ...
    return function($scope) {
        var uibModalInstance = $uibModal.open({
            ...
            template: "<div class=\"modal-header\">" +
                           ...
                           "<h3 class=\"modal-title\" id=\"modal-title\"><span class=\"fa fa-fw fa-crosshairs\"></span> {{ Orden }}</h3>" +
                        "</div>" +
                        "<div class=\"modal-body\" id=\"modal-body\">" +
                            "<div bind-html-compile=\"rawHtml\">Loading...</div>" +
                        "</div>" +
                        "<div style=\"text-align:center;\" class=\"modal-footer\">" +
                            "<button ng-click=\"putOrderOnHold();\" type=\"button\" class=\"btn btn-md btn-info radius-50\" style=\"border-radius:50px\"><span class=\"fa fa-fw fa-save\"></span> Guardar &rarr;</button>" +
                        "</div>",
            controller: function ($scope, $uibModalInstance) {
                ...
                if (window.getParameterByName("holding_id")) {
                    window.swal({
                      title: "Oops!",
                      text: "Porfavor, cancelar primero la orden de retención existente",
                      icon: "error",
                      buttons: true,
                      dangerMode: false,
                    })
