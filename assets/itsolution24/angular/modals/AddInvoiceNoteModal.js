        ...
        var uibModalInstance = $uibModal.open({
            ...
            template: "<div class=\"modal-header\">" +
                        ...
                        "<div class=\"modal-body\" id=\"modal-body\">" +
                            "<input type=\"text\" id=\"note\" class=\"form-control\" rows=\"3\" value=\"{{ invoiceNote }}\" placeholder=\"Placa...\">" +
                        "</div>" +
                        "<div class=\"modal-footer\">" +
                            "<button ng-click=\"clear();\" class=\"btn btn-danger\" type=\"button\"><span class=\"fa fa-fw fa-close\"></span> Cerrar&nbsp;</button>" +
                            "<button ng-click=\"closeAddNoteModal();\" id=\"reset-btn\" name=\"reset-btn\" class=\"btn btn-success\"><span class=\"fa fa-fw fa-check\"></span> Guarar </button>&nbsp;&nbsp;" +
                        "</div>",
            controller: function ($scope, $uibModalInstance) {
                $scope.modal_title = "Agregar Placa";            
                 var invoiceNote;
